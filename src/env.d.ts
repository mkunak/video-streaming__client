...
interface ImportMetaEnv {
  ...
  readonly NG_APP_CLIENT_PORT: string;
  readonly NG_APP_CLIENT_BASE_URL: string;
  readonly NG_APP_API_SERVER_PORT: string;
  readonly NG_APP_API_SERVER_BASE_URL: string;
  [key: string]: any;
}
